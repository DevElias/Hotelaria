...
class CreateCategoriasperguntasTable extends Migration
{
    public function up()
    {
        Schema::create('categoriasperguntas', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('categoriasperguntas');
    }
}
