	    		...
	    		<div className="card-body">
                    {
                        subcategorias.map(subcategoria => (
                            <a key={subcategoria.id} data-target="#accordion" data-toggle="collapse" onClick={() => this.props.handler(subcategoria.id)} className="dropdown-item" href="#">{subcategoria.subcategoria}</a>
                        ))
                    }
                </div>
        )
