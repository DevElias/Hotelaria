    ...
    render(){
    	...
    	return (
    			<Fragment>
	        		{
	        			areas.map(area => (
	        				 <div key={area.id} id={area.id}className="form-check col-12 col-md-4">
	                            <input className="form-check-input" type="checkbox" value="" id={'checkboxArea'+area.id} onClick={() => this.props.handler(area.id)} />
